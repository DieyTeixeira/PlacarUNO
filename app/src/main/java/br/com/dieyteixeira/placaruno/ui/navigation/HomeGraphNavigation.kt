...
fun NavGraphBuilder.homeGraph(
    ...
    navigation(
        ...
        playersScreen(
            onNavigateToNewPlayerForm = onNavigateToNewPlayerEdit,
            onNavigateToEditPlayerForm = onNavigateToEditPlayerEdit,
            onPopBackStack = onPopBackStack
        )
        playerFormScreen(onPopBackStack = onPopBackStack)
        teamsScreen(
            onNavigateToNewTeamForm = onNavigateToNewTeamEdit,
            onNavigateToEditTeamForm = onNavigateToEditTeamEdit,
            onPopBackStack = onPopBackStack
        )
